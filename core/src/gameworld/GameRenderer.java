...
import static fbHelpers.AssetLoader.birdDown;
import static fbHelpers.AssetLoader.birdUp;
import static fbHelpers.AssetLoader.getGetReadyLogo;
import static fbHelpers.AssetLoader.getReady;
...
public class GameRenderer {
    ...
    public void render(float runTime) {
        ...
        if (myWorld.isReady()) {
            batcher.draw(getReady, (136/2)-(45/2), midPointY/2-(37/2)+4 );
            batcher.draw(getGetReadyLogo, 3,5);
        } else {
